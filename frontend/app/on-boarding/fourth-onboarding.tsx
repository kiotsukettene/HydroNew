...
export default function FourthOnboarding() {
    ...
    <SafeAreaView className="flex-1 items-center bg-primary/10">
      <View className="w-full flex-1 items-center justify-center gap-8 px-4">
        ...
        <View className="w-full items-center">
          <LottieView
            source={require('@/assets/lotties/Greenify the Earth.json')}
            style={{
        ...
        <View className="w-full items-center gap-4 p-6">
          <View className="gap-4">
            <Text className="text-center font-finger-paint text-4xl ">
              Empowering a Sustainable Future
            </Text>
            <Label className="text-center font-poppins text-base font-normal ">
              HydroNew transforms wastewater into opportunity that promotes clean water, renewable
